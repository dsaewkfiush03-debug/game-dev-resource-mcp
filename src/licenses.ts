...
export const LICENSE_RULES: LicenseRule[] = [
  ...
  { id: "CC-BY-3.0", aliases: ["CC BY 3.0", "Creative Commons Attribution 3.0"], risk: "attribution", commercialUse: true, modification: true, redistribution: true, attribution: true, shareAlike: false, notes: "Attribution is required. Some distribution/DRM scenarios can require additional review; verify the full license and target platform." },
  { id: "CC-BY-4.0", aliases: ["CC BY 4.0", "Creative Commons Attribution 4.0"], risk: "attribution", commercialUse: true, modification: true, redistribution: true, attribution: true, shareAlike: false, notes: "Attribution and change indication are required; verify distribution restrictions for the target platform." },
  { id: "OGA-BY-3.0", aliases: ["OGA BY 3.0", "OGA-BY 3.0", "OpenGameArt Attribution 3.0"], risk: "attribution", commercialUse: true, modification: true, redistribution: true, attribution: true, shareAlike: false, notes: "OpenGameArt attribution license. Commercial use is allowed with attribution; verify the original asset page and license text." },
  { id: "OGA-BY-4.0", aliases: ["OGA BY 4.0", "OGA-BY 4.0", "OpenGameArt Attribution 4.0"], risk: "attribution", commercialUse: true, modification: true, redistribution: true, attribution: true, shareAlike: false, notes: "OpenGameArt attribution license. Commercial use is allowed with attribution; verify the original asset page and license text." },

  { id: "CC-BY-SA-3.0", aliases: ["CC BY-SA 3.0"], risk: "conditional", commercialUse: true, modification: true, redistribution: true, attribution: true, shareAlike: true, notes: "Commercial use is allowed, but attribution and share-alike apply to derivatives. Review DRM/platform compatibility and derivative boundaries before integration." },
  ...
  { id: "GPL-2.0", aliases: ["GPL-2.0-only", "GPLv2", "GNU GPL v2"], risk: "conditional", commercialUse: true, modification: true, redistribution: true, attribution: true, shareAlike: true, notes: "Commercial use is possible, but GPL obligations and application to game art are context-dependent. Require project-level review." },
  { id: "GPL-3.0", aliases: ["GPL-3.0-only", "GPLv3", "GNU GPL v3"], risk: "conditional", commercialUse: true, modification: true, redistribution: true, attribution: true, shareAlike: true, notes: "Copyleft obligations can affect distributed software or derivative assets; require project-level review." },
  { id: "LGPL-2.1", aliases: ["LGPL-2.1-only", "LGPLv2.1", "GNU LGPL v2.1"], risk: "conditional", commercialUse: true, modification: true, redistribution: true, attribution: true, shareAlike: "depends", notes: "Commercial use is possible, but redistribution/modification obligations require implementation-specific review." },
